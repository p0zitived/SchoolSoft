...
namespace SchoolSoft.MainLogic
{
    class Group
    {
        ...
        // constructors
        public Group(int id,int year,char letter,Teacher classMaster) { ID = id;GroupYear = year;GroupLetter = letter; ClassMaster = ClassMaster; Students = new List<Student>(); }
